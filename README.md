...
| OPERATOR | **Харилцагч** — бараа нийлүүлдэг түнш | Захиалга шивэх, өөрийн захиалгын статус |
| DRIVER | Жолооч | Өөрийн хүргэлт, зурагтай баталгаажуулалт, цалингийн задаргаа |
| CUSTOMER | Портал хэрэглэгч (онлайн захиалагч) | Бүртгүүлж захиалах, tracking, нэхэмжлэх |
