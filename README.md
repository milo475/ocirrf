...
**Сургуулийн нэмэлтүүд (2026-09-04, migration
`20260904150000_studexa_school_features`):** хичээл (судлагдахуун —
`StudexaSubject`, хуваарь/дүнгийн багана үүгээр бүлэглэгдэнэ), улирал
(`StudexaTerm`, багана улиралд хамаарна, «одоогийн улирал»), үнэлгээний
хуваарь (багш бүр `gradingScale` — default A/B/C/D/F 90/80/70/60), дүнгийн
хуудас (`GET students/:id/report-card?term=` — хичээл бүрээр оноо, нийт хувь,
үсгэн үнэлгээ, улирлын ирц, ангийн эрэмбэ; сурагч порталаас
`portal/report-card`), ангийн нэгтгэлд үнэлгээ + эрэмбэ, сурагчийн профайл
(регистр, төрсөн огноо, хүйс, хаяг) ба **төлөв** (ACTIVE/GRADUATED/LEFT —
төгссөн/шилжсэн сурагч жагсаалт, ирц, нэгтгэл, самбарт орохгүй, `?status=ALL`),
сурагчийн хувийн тэмдэглэл (`StudexaStudentNote`, багшид л), төлбөрт **он**
(`StudexaPayment.year`, unique org+student+year+month), хуваарийн **зөрчлийн
шалгалт** (ижил гараг, цаг давхцсан, бүлэг огтлолцсон → 400), хичээлийн
сэдвийн журнал (`StudexaLessonEntry` — ирцтэй хамт `topic`), тасалсны
мэдэгдэл (шинээр ABSENT болсон холбогдсон сурагчид апп-мэдэгдэл + SMTP
байвал и-мэйл), сурагчдын **CSV импорт** (`POST students/import`, монгол/англи
