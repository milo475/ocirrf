...
const DICT = {
  ...
  en: {
    ...
    'Сурагч': 'Student',
    // — Нууц үг сэргээх —
    'Бүртгэлтэй и-мэйл хаягаа оруулбал нууц үг сэргээх холбоос илгээнэ.': 'Enter your registered email and we will send a reset link.',
    'Сэргээх холбоос илгээх': 'Send reset link',
    'Илгээж байна…': 'Sending…',
    'Хэрэв энэ и-мэйл бүртгэлтэй бол сэргээх холбоос илгээгдлээ. Захидлаа (спам хавтсаа ч) шалгана уу — холбоос 30 минут хүчинтэй.': 'If this email is registered, a reset link has been sent. Check your inbox (and spam) — the link is valid for 30 minutes.',
    'И-мэйл хүлээж авахгүй бол админд хандаж түр нууц үг авна уу.': 'If you cannot receive email, ask your admin for a temporary password.',
    'Шинэ нууц үг тохируулах': 'Set a new password',
    'Сэргээх холбоос буруу байна. И-мэйл дэх холбоосоор дахин орно уу.': 'Invalid reset link. Please open the link from your email again.',
    'Нууц үг амжилттай солигдлоо. Шинэ нууц үгээрээ нэвтэрнэ үү.': 'Password changed. Log in with your new password.',
    'Шинэ нууц үгээ хоёр удаа оруулна уу (хамгийн багадаа 6 тэмдэгт).': 'Enter your new password twice (at least 6 characters).',
    'Шинэ нууц үг': 'New password',
    'Шинэ нууц үг (давтах)': 'New password (repeat)',
    'Хадгалж байна…': 'Saving…',
    'Нууц үг солих': 'Change password',
    'Нэвтрэх хуудас': 'Login page',
    'Харанхуй': 'Dark',
    'Цайвар': 'Light',
